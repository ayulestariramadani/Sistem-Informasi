			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1><?php echo $u->judul_ta; ?></h1>
				   					<h2><a href="index.html">Home</a> - <a href="project.html">detail</a></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			...
			<div class="container">
				<div class="row row-pb-lg">
					...
					<div class="row">
						...
						<div class="col-md-3 animate-box">
							<a href="#" class="staff-img staff-img2" style="background-image: url('<?php echo base_url()?>images/default.png');">
								<div class="desc-staff">
									<h3><?php echo $u->penulis1; ?></h3>
						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingOne">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Pembimbing
										</a>
									</h4>
								</div>
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="panel-body">
										<ol>
											<li><?php echo $u->pembimbing1?></li>
											<li><?php echo $u->pembimbing2?></li>
										</ol>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingTwo">
									<h4 class="panel-title">
										<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Tujuan
										</a>
									</h4>
								</div>
								<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									<div class="panel-body">
										<p><?php echo $u->tujuan?></p>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingThree">
									<h4 class="panel-title">
										<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Latar Belakang
										</a>
									</h4>
								</div>
								<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
									<div class="panel-body">
										<p><?php echo $u->latarbelakang?></p>	
									</div>
								</div>
							</div>
						</div>	
			...
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-4 colorlib-widget">
						<h4>Instagram</h4>
						<div class="instagram">
							<a href="" class="insta-img" style="background-image: url('<?php echo base_url()?>images/building-1.jpg');"></a>
							<a href="#" class="insta-img" style="background-image: url('<?php echo base_url()?>images/building-2.jpg');"></a>
							<a href="#" class="insta-img" style="background-image: url('<?php echo base_url()?>images/building-3.jpg');"></a>
							<a href="#" class="insta-img" style="background-image: url('<?php echo base_url()?>images/building-4.jpg');"></a>
							<a href="#" class="insta-img" style="background-image: url('<?php echo base_url()?>images/building-5.jpg');"></a>
							<a href="#" class="insta-img" style="background-image: url('<?php echo base_url()?>images/building-6.jpg');"></a>
						</div>
					</div>
